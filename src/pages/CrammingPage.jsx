...
<<<<<<< HEAD
    <div className="cramming-intro">
      <div className="cramming-header">
        <h1>⚡ 벼락치기 모드</h1>
        <p className="cramming-subtitle">
          시간이 부족할 때, AI가 당신을 위한 최적의 학습 계획을 세워드립니다
        </p>
      </div>
=======
...
>>>>>>> 3bdbd1628d13e8239bfda684ecde005413904f23
      ...
      <div className="cramming-comparison">
        ...
        <div className="mode-card highlight">
          ...
          <p className="mode-description">
            마지막 시험까지 남은 시간을 고려해 자동으로 최적화된 학습 순서 제공
          </p>
        </div>
      </div>
            ...
            >
              ...
              <div className="timeline-content">
                ...
                <p>
                  시험까지: D-
                  {Math.ceil(
                    (new Date(subject.date) - new Date()) /
                      (1000 * 60 * 60 * 24)
                  )}
                </p>
                {index === currentStep && (
                  <button
                    ...
                    onClick={() => navigate(`/task/${subject.id}/1`)}
                  >
                    지금 공부하기
                  </button>
                )}
